...
final class Schema32 extends i0.VersionedSchema {
  ...
  late final Shape52 remoteAlbumEntity = Shape52(
    source: i0.VersionedTable(
      entityName: 'remote_album_entity',
      withoutRowId: true,
      isStrict: true,
...
final class Schema33 extends i0.VersionedSchema {
  ...
  late final Shape53 remoteAssetEntity = Shape53(
    source: i0.VersionedTable(
      entityName: 'remote_asset_entity',
      withoutRowId: true,
      isStrict: true,
...
class Shape53 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get visibility =>
      columnsByName['visibility']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get hiddenFrom =>
      columnsByName['hidden_from']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get stackId =>
      columnsByName['stack_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get libraryId =>
      columnsByName['library_id']! as i1.GeneratedColumn<String>;
...
final class Schema34 extends i0.VersionedSchema {
  ...
  late final Shape54 remoteAlbumEntity = Shape54(
    source: i0.VersionedTable(
      entityName: 'remote_album_entity',
      withoutRowId: true,
      isStrict: true,
...
final class Schema35 extends i0.VersionedSchema {
  ...
  late final Shape55 remoteAssetEntity = Shape55(
    source: i0.VersionedTable(
      entityName: 'remote_asset_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  late final Shape56 remoteAlbumEntity = Shape56(
    source: i0.VersionedTable(
      entityName: 'remote_album_entity',
      withoutRowId: true,
      isStrict: true,
...
class Shape55 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get hiddenFrom =>
      columnsByName['hidden_from']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get hiddenFromInherited =>
      columnsByName['hidden_from_inherited']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get hiddenFromShown =>
      columnsByName['hidden_from_shown']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get stackId =>
      columnsByName['stack_id']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get libraryId =>
      columnsByName['library_id']! as i1.GeneratedColumn<String>;
