...
class MediumRepositoryContext {
  ...
  Future<RemoteAssetEntityData> newRemoteAsset({
    ...
    Iterable<AssetSurface>? hiddenFromInherited,
    Iterable<AssetSurface>? hiddenFromShown,
    int? durationMs,
    int? width,
    int? height,
    bool? isFavorite,
    ...
    return db
        ...
        .insertReturning(
          RemoteAssetEntityCompanion(
            ...
            hiddenFromInherited: .new(VisibilityPolicy.maskFor(hiddenFromInherited ?? const [])),
            hiddenFromShown: .new(VisibilityPolicy.maskFor(hiddenFromShown ?? const [])),
