...
class RemoteAlbumService {
  ...
  Future<void> setLocked(String albumId, bool isLocked, {bool includeSubAlbums = false}) {
    return _albumApiRepository.setLocked(albumId, isLocked, includeSubAlbums: includeSubAlbums);
  }

  /// See [AlbumApiRepository.getLockImpact].
  Future<AlbumLockImpactResponseDto> getLockImpact(String albumId, {bool includeSubAlbums = false}) {
    return _albumApiRepository.getLockImpact(albumId, includeSubAlbums: includeSubAlbums);
  }
